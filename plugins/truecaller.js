...
inrl({
	...
	let user = (message.client.mention.jid?.[0] || message.reply_message.mention.jid?.[0] || match || message.reply_message.text || '').replace(/[^0-9]/g, '');
